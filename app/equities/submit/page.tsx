      ...
      <section className="bg-brand-black py-20 md:py-32">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-brand-silver max-w-3xl">
            Have an investment opportunity? Reach out to discuss the details.
          </p>
        </div>
      </section>
      ...
      <section className="bg-brand-white py-32 md:py-48">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Note about deal submissions */}
            <div className="mt-16 p-8 border border-brand-silver-light">
              <h3 className="text-2xl font-bold text-brand-black mb-4">Deal Submissions</h3>
              <p className="text-brand-silver-dark leading-relaxed">
                Please reach out via phone or email with details about your investment opportunity. We review all submissions and respond within 48 hours.
              </p>
            </div>
          </div>
        </div>
